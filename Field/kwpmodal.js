...
customElements.define('a.select-link', class extends HTMLElement {
 /* get labelText() {
...
*/
  onClick() {
    fetch(new URL(`${this.systemPaths.baseFull}index.php?option=com_ajax&type=plugin&plugin=kwpmodal&group=system&method=kwpmodal&format=json&${this.token}=1`), {method: 'POST'})
    .then((response)=>{
